  ...
  <div class="mydiv2">
    <div class="mydiv1">
        <p class="scritta">Vuoi aggiungere un tocco<br> di stile alla tua casa ? <br>
                          Magari in maniera da stupire <br> i tuoi ospiti ?</p>
        <div class="polaroid">
          <img src="../Immagini/ImmagineHome1.jpg"  alt="Plan con gli amici" height="600"/>
        </div>
    </div>

    <div class = "mydiv1">
        <div class="polaroid">
          <img src="../Immagini/Sfondo.jpg"  alt="Organizza online" height="380" />
        </div>    
    ...
    <div class = "mydiv1">
        ...
        <div class="polaroid">
          <img src="../Immagini/ImmagineHome3.jpg"  alt="Organizza online" height="600" />
        </div>
    </div>
    ...
    <fieldset class="descrizione">
        ...
        <p class="testoBase">
                ...
                come vediamo anche nella moda le fantasie a tema mitologico stanno ritornando sempre di piú. <br><br>
                Perciò se vuoi stupire i tuoi ospiti e mostrarti come una persona che ha occhio per la bellezza e il design
                ...
                iscriverti alla nostra newsletter, tramite la sezione qua sotto !
        </p>
    </fieldset>  
  </div>
</div>
