            ...
            <header class="p-3 bg-dark text-white sticky-top">
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <div class="text-end">
                            <a href="../ModificaUtente/modifica.php" <button type="button" class="btn btn-outline-light me-3">Modifica Profilo</button></a>
                            <a href="../Prodotti/finisci.php" <button type="button" class="btn btn-outline-light me-3">Carrello</button></a>
            ...
            <header class="p-3 bg-dark text-white sticky-top">
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <div class="text-end">
                            <a href="../Login/FormLogin.php" <button type="button" class="btn btn-outline-light me-3">Accedi</button> </a>
                            <a href="../Prodotti/finisci.php" <button type="button" class="btn btn-outline-light me-3">Carrello</button></a>
